    ...
    function () {
      ...
      _proto.fixLayoutHeight = function fixLayoutHeight() {
        ...
        if (max == heights.window) {
          $(Selector.CONTENT).css('max-height', max - heights.header - heights.footer);
          $(Selector.CONTENT).css('overflow-y', 'auto');
        } else {
          $(Selector.CONTENT).css('max-height', max - heights.header);
        }
