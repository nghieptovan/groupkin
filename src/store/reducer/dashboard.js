...
const dashBoard = (state={
	user:{photo:'/external/img/samples/ryan.png',name:'NghiepTO'},
	...
	ajaxErrors:[],
	table:[
		{iconClassname:'fa fa-dashboard',link:'/dashboard',name:'Dashboard',itung:28},
		{iconClassname:'fa fa-list',link:'/posts',name:'Posts',itung:0},
		{iconClassname:'fa fa-users',link:'/users',name:'Users',itung:0},
	],
	modalContent:{
		body:'',header:'',footer:'',
	},
