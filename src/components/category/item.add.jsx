...
class AddItem extends Component{
    ...
    componentDidMount(){
        ...
        let buildCate = buildCategoryManageDropDown(this.state.datacategory);
        
        this.setState({
            categories: buildCate, itemAdd: itemAdd
        });
    ...
    saveDataNew = () => {
        let { itemAdd , selectedCategory, status} = this.state;
        itemAdd.active = status;
        if(selectedCategory){
            itemAdd.category = selectedCategory._id
        }
        console.log(itemAdd);
    ...
    render() {
        const { item, idx, config, type, slug, label, active, itemAdd: {
            title, description, name, url, thumbnail, replace_image, banner_endpost, banner_sidebar, banner_top
        }, activeAdd, categories, selectedCategory  } = this.state;
