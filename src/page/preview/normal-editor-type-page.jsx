...
class NormalEditorTypePage extends Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    return (
      <div className="previewpage-saostar">
        ...
        <article className="mt40 w1000 ma m-w-90">
          <div className="breadcrumb-article">
            {/* <a href="#">Thể thao</a>
            <span className="ssf-left-open-mini rotate-180 f16"></span>
            <a href="#" className="active">Bóng đá</a> */}
          ...
          {
            postContent.series &&
            <a className="d-inline-block mt-4 bg-red text-white ff-bold fz12 text-uppercase py-1 px-2 bg-hover-black text-hover-white" style={{ fontSize: "12px", fontWeight: "500" }}>{postContent.series.label}</a>
          }
          {/* <a href="#" className="tag-tab-3 mt20 dis-block">Copa America</a> */}
          ...
          <div className="article-content display-flex flex-prop-jcsb mt20">
            <div className="w-offset-30 pr40 m-w-100">
              ...
              {/* <div className="clearfix mt20">
                <span className="fr author bottom"><span className="ssf-palette"></span> Hưng Cafe</span>
                <span className="fr author bottom"><span className="ssf-picture"></span> Văn Toàn</span>
                <span className="fr author bottom"><span className="ssf-camera"></span> Tuấn Anh</span>
                <span className="fr author bottom"><span className="ssf-video"></span> Phượng Messi</span>
              </div> */}
            ...
            <div className="w-30">
              <span href="#" className="holder-banner mb20">
                <img src={process.env.PUBLIC_URL + "/assets/images/300x600.png"} alt="" />
              </span>
            </div>
          </div>
        </article>
...
NormalEditorTypePage.propTypes = {

};


export default NormalEditorTypePage;
