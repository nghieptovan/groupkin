			...
			<div className="d-flex align-items-center py-1">
				...
				<div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484e382cca3">
					...
					<div className="mb-10">
						...
						{/*<!--begin::Input-->*/}
						<div>
						<select className="form-select form-select-solid select2-hidden-accessible" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484e382cca3" data-allow-clear="true" data-select2-id="select2-data-7-rl20" tabIndex="-1" aria-hidden="true">
							<option data-select2-id="select2-data-9-ukbr"></option>
							<option value="1">Approved</option>
							<option value="2">Pending</option>
							<option value="2">In Process</option>
							<option value="2">Rejected</option>
						</select><span className="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-ibus" style={{width: "100%"}}><span className="selection"><span className="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="0" aria-disabled="false" aria-labelledby="select2-ajrz-container" aria-controls="select2-ajrz-container"><span className="select2-selection__rendered" id="select2-ajrz-container" role="textbox" aria-readonly="true" title="Select option"><span className="select2-selection__placeholder">Select option</span></span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span className="dropdown-wrapper" aria-hidden="true"></span></span>
						</div>
						{/*<!--end::Input-->*/}
					</div>
					{/*<!--end::Input group-->*/}
								...
								<div className="g-5 gx-xxl-8">
									...
									<div className="card card-xxl-stretch">
										...
										<div className="card-header">
											...
											<div className="card-toolbar">
												<a href="../../demo13/dist/apps/calendar.html" className="btn btn-primary">Manage Calendar</a>
											</div>
										</div>
										{/*end::Card header*/}
										{/*begin::Card body*/}
